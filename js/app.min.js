...
document.addEventListener('DOMContentLoaded', function () {
  ...
  // team slider
  var teamSlider = document.querySelector('.team__slider .swiper');
  if (teamSlider) {
    var myTeamSlider = new Swiper(teamSlider, {
      slidesPerView: 1,
      loop: true,
      speed: 800,
      parallax: true,
      watchSlidesProgress: true,
      navigation: {
        prevEl: teamSlider.closest('.team').querySelector('.swiper-button-prev'),
        nextEl: teamSlider.closest('.team').querySelector('.swiper-button-next')
      },
      pagination: {
        el: teamSlider.closest('.team').querySelector('.swiper-pagination'),
        clickable: true
      }
    });
  }
  ...
  if (checklistSlider) {
    var myChecklistSlider = new Swiper(checklistSlider, {
      ...
      watchSlidesProgress: true,
      navigation: {
        prevEl: checklistSlider.closest('.checklist').querySelector('.swiper-button-prev'),
        nextEl: checklistSlider.closest('.checklist').querySelector('.swiper-button-next')
      },
      pagination: {
        el: checklistSlider.closest('.checklist').querySelector('.swiper-pagination'),
        clickable: true
      }
    });
  }
